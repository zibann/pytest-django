...
def _delete_setting(test_node, settings, setting, enter):
    from .compat import setting_changed
...
class SettingsMonkeyPatchWrapper(object):
    def __init__(self, node, django_settings):
        super(SettingsMonkeyPatchWrapper, self).__setattr__('_node', node)
        super(SettingsMonkeyPatchWrapper, self).__setattr__('_django_settings',
                                                            django_settings)
        super(SettingsMonkeyPatchWrapper, self).__setattr__('_to_restore', [])
...
def settings(request):
    ...
    wrapper = SettingsMonkeyPatchWrapper(request.node, django_settings)
